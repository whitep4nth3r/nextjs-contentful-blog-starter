...
export default function Header() {
  ...
  const VisibleMenu = mobileMenu ? "w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto"
   : "w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto md:hidden sm:hidden";


  return (

<nav className="flex items-center justify-between flex-wrap bg-blue-500 p-6 ">
<div className={mobileMenu ? "block md:container md:mx-auto" : "flex md:container md:mx-auto"}>
<div className="flex items-center flex-1 text-white mr-6">
    <svg className="flex h-8 w-8 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
    <span className="flex font-semibold text-xl tracking-tight">Testing page</span>
  </div>
  
  <div className="shrink-0 lg:hidden">
    <button onClick={() => handleMobileMenu()} className="flex items-center px-3 py-2 border rounded text-white border-white hover:text-white hover:border-white">
  ...
  <div className={VisibleMenu}>
    ...
    <div>
    <Link href='/newItem'><a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Přidat záznam</a></Link>
    </div>
  </div>
  </div>
</nav>
